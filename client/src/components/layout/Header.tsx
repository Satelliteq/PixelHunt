...
import { ExtendedUser } from '@/lib/AuthContext';
...
export default function Header() {
  ...
  const isUserAdmin = () => {
    ...
    // Hardcoded admin listesi kontrolü
    const ADMIN_LIST = {
    ...
    return (
      ADMIN_LIST.emails.includes(extendedUser.email || '') ||
      ADMIN_LIST.uids.includes(extendedUser.uid) ||
      extendedUser.role === 'admin' ||
      extendedUser.customClaims?.role === 'admin'
    );
  };
      ...
      >
        ...
        <div className="flex flex-col space-y-4">
          ...
          <Button 
            ...
            onClick={() => handleNavigation("/rooms")}
          >
            <Users className="w-5 h-5 mr-3" /> Odalar
          </Button>
          ...
          <Button 
            ...
            onClick={() => handleNavigation("/contact")}
          >
            <Users className="w-5 h-5 mr-3" /> Ekibimiz
          </Button>
        </div>
