...
import { UserCircle, Mail, KeyRound, LogOut, AlertTriangle, Sparkles, Globe, User, Settings, Shield, Calendar, Clock, Trophy, Medal, Award, BookOpen, History, Edit, Save, Loader2 } from 'lucide-react';
