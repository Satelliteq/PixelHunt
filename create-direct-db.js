// Doğrudan PostgreSQL bağlantısı ile veritabanı oluşturma scripti
...
async function insertSampleData() {
  ...
  try {
    ...
    const categoryResult = await client.query(`
      INSERT INTO categories (name, description, icon_name, color, background_color, "order", active)
      VALUES 
        ('Arabalar', 'Otomobil markaları ve modelleri', 'car', '#EF4444', '#FEF2F2', 1, true),
        ('Coğrafya', 'Dünya üzerindeki yerler ve landmark''lar', 'map', '#3B82F6', '#EFF6FF', 2, true),
        ('Film & TV', 'Filmler, TV şovları ve karakterler', 'film', '#8B5CF6', '#F5F3FF', 3, true),
        ('Sanat', 'Ünlü sanat eserleri ve sanatçılar', 'palette', '#EC4899', '#FDF2F8', 4, true),
        ('Müzik', 'Şarkıcılar, gruplar ve albümler', 'music', '#10B981', '#ECFDF5', 5, true)
